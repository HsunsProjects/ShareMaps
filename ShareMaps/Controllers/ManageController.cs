    ...
    public class ManageController : Controller
    {
        ...
        public async Task<ActionResult> Index(ManageMessageId? message)
        {
            ViewBag.StatusMessage =
                ...
                : message == ManageMessageId.ChangeNicknameSuccess ? "已設定您的稱呼。"
        ...
        //
        // POST: /Manage/EditNickname
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<ActionResult> EditNickname(string nickname)
        {
            ...
            if (result.Succeeded)
            {
                User.AddUpdateClaim("Nickname", nickname);
